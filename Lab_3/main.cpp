...
int main() {
    ...
    Set<int> *setInt1 = new Set<int>;
    Set<int> *setInt2 = new Set<int>;
    int nInt;

    Set<float> *setFloat1 = new Set<float>;
    Set<float> *setFloat2 = new Set<float>;
    float nFloat;
    ...
    Set<string> *setString1 = new Set<string>;
    Set<string> *setString2 = new Set<string>;
    string nString;

    Set<Person> *setPerson1 = new Set<Person>;
    Set<Person> *setPerson2 = new Set<Person>;
    Person nPerson;
